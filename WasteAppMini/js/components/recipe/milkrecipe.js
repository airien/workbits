...
var recipes = require('../../data/meieri.json');
...
class Milk extends Component {
 ...
 <AndroidBackButton
        ...
        <Content padder>
          ...
          <DynamicView data={recipes.texts} name="milk" />
          </Content>
      </Container>
    );
  }
...
export default connect(mapStateToProps, bindAction)(Milk);
