...
return (
      <Container theme={myTheme} style={styles.container}>
        ...
        <Content padder>
          ...
          <Button block style={styles.osteknapp} onPress={() => this.replaceAt('bread')}>{recipeItems.bread}</Button>
          <Button block style={styles.andreknapp} onPress={() => this.replaceAt('fruitveg')}>{recipeItems.fruitveg}</Button>
          <Button block style={styles.melkeknapp} onPress={() => this.replaceAt('meat')}>{recipeItems.meat}</Button>
          <Button block style={styles.osteknapp} onPress={() => this.replaceAt('other')}>{recipeItems.oppskrifter}</Button>
        </Content>
      </Container>
);
  }
